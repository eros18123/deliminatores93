...
class CustomDialog(QDialog):
    ...
    def show_all_cards(self):
        ...
        # A LINHA PROBLEMÁTICA FOI REMOVIDA DESTA FUNÇÃO INTERNA
        def clean_tags(text):
            text = re.sub(r'(<img[^>]*)alt="[^"]*"([^>]*>)', r'\1\2', text)
            # A LINHA ABAIXO ERA O PROBLEMA E FOI REMOVIDA. ELA CORROMPÍA O CSS.
        ...
        card_lines = []
        self.card_notetypes = []
        self.shown_note_ids.clear() # --- LIMPA A LISTA DE IDS ANTIGOS ---
        ...
        for nid in note_ids:
            ...
            if any(c.isalpha() for c in card_line):
                ...
                self.shown_note_ids.append(nid) # --- ARMAZENA O ID DA NOTA ---
