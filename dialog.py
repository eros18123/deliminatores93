...
class CustomDialog(QDialog):
    ...
    def _apply_real_time_edit(self):
        ...
        try:
            ...
            # Lógica aprimorada para atualizar a tela de revisão em tempo real.
            if mw.state == "review" and mw.reviewer.card and mw.reviewer.card.nid == note_id:
                # 1. Força o card na tela de revisão a recarregar seus dados do banco de dados.
                mw.reviewer.card.load()
                
                # 2. Agora, força a re-exibição com os dados recarregados,
                #    seja da frente ou do verso.
